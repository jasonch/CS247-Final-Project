function load_friends () {
    var searchbox = 
      ...
      for (var i = 0; i < friends.data.length && i < 20; i++) {
        ...
        $('#friend-item-' + id).bind ('click', {fid:id}, function (event) {
          window.open (AJAX_DIR + "challengeFriend.php?from="+USER_INFO.user_id + "&to=" + event.data.fid, 
            "Challenge A Friend", "status=0,toolbar=0,menubar=0,resizable=0,height=300,width=300");
        });
      }
