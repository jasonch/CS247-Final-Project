...
function formatUserInfo(user) {
  ...
  if (user.status == null) {
    result += "<div class='user_status'><input type='text' id='user-status-box' value='set your status here' onclick='clearText(this)' onChange='updateStatus(this);' size='40'></input></div>";
  } else {
